    ...
    <div class="list-article-info">
        <p class="list-article-info-p">收录于 <b style="color: #4a78db;"><?php $the_post_category = get_the_category(get_the_ID()); echo $the_post_category[0]->cat_name; ?></b> | <b style="color: #fabc05;"><?php if(function_exists('the_views')) { the_views(); } ?>次</b> 浏览</p>
